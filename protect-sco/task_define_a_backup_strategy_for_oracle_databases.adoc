...
+
You can create only offline-mount backups of Data Guard standby databasess of Data Guard standby databases. Offline-shutdown backup, archive log only backup or full backup is not supported.
